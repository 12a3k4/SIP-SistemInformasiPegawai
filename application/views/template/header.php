    ...
    <header class="main-header">
      ...
      <a href="" class="logo">
        ...
        <span class="logo-mini">
          <img src="<?= base_url('template/logo4.png') ?>" alt="Mini Logo"
            style="width: 50px; height: 50px; display: block;">
        </span>
        <!-- Logo for regular state and mobile devices -->
        <span class="logo-lg">
          <img src="<?= base_url('template/logo5.png') ?>" alt="Full Logo"
            style="height: 50px; width: 225px; display: block;">
        </span>
      </a>
      ...
      <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <!-- <li>
              <a href="<?= base_url('laporan/about_us'); ?>">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <ul class="treeview-menu">
            ...
            <!-- <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?= base_url('laporan/about'); ?>"><i class="fa fa-circle-o"></i>About Us </a>
                </li>
              </ul>
            </li> -->
