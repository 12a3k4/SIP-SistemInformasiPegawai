    ...
    public function index()
    {
        if (isset($_POST['login'])) {
            ...
            if ($admin->num_rows() > 0) {
                ...
                $this->session->set_flashdata('pesan', '<div class="btn btn-primary">Maaf Informasi Login Tidak Di Kenali <br />Username Dan Password Salah</div>');
                redirect(base_url(''));
            }
        } else { 
            $x = array(
